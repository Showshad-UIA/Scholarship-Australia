...
const JobChoice = () => {
  return (
    <div className="mx-auto container">
      <div className="shadow-md rounded border-2  my-20 lg:mx-60">
        <h1 className="mt-3  mb-10 font-sans text-center text-2xl ">
      ...
      "
        ...
        <button className=" bg-[#304F40] font-sans rounded-md flex justify-center text-white p-3 mb-3">
          Join as
        </button>
      </div>
    </div>
