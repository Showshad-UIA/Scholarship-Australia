      ...
      <div className="flex justify-center items-center lg:mt-20 w-full  py-4  overflow-hidden bg-white shadow-md sm:max-w-lg sm:rounded-lg mb-5">
        <div className="card flex lg:w-96 px-5 w-80  mb-5">
          ...
          <div className="my-8">
            <div className="flex flex-col items-start">
              <input
                ...
                className="appearance-none block w-full  text-gray-700 border border-gray-200 rounded-sm py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-red-400 input input-bordered "
              />
            </div>
          </div>
          ...
          <div className="my-10">
            ...
            <button
              className=" bg-[#304F40] px-2 cursor-pointer text-[20px] font-bold rounded-sm mt-7 mb-5 text-white p-3 w-full"
