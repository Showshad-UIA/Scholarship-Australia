          ...
          <div className="lg:mx-[300px]  mb-7 border-2 rounded-[5px]  ">
            <div className="flex  ">
              <div className="w-[30%]">
                <img
                  src={photo}
                  className="p-5 lg:w-[400px] lg:h-[270px] "
                ></img>

                <div>
                  <p className="mt-12 px-2 font-sans font-bold mb-3" >Hourely rate</p>
                  <div className="col-md-3 w-[270px]  border-2 border-[#56B55D] px-2  mx-2 ">
